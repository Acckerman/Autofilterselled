...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        return await query.answer('♥️ Thank You acckerman ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/Malyalam_Mallu_Movies')
        ], [
    ...
    await query.answer('♥️ Thank You Acckerman ♥️')
